...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="postgresAdmin@techconf-postgres-db-server", password="single123@", host="techconf-postgres-db-server.postgres.database.azure.com")
